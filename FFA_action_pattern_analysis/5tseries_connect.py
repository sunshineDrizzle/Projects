...
if __name__ == '__main__':
    ...
    output_file = pjoin(connect_dir, 'connectivity_sess2.npy')
    tseries_LR_file = pjoin(connect_dir, '{subject}/rfMRI_REST2_LR.npy')
    tseries_RL_file = pjoin(connect_dir, '{subject}/rfMRI_REST2_RL.npy')
